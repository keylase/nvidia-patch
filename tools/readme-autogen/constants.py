...
DATAFILE_PATH = os.path.join(BASE_PATH, "..", "..", "drivers.json")
LINUX_README_PATH = os.path.join(BASE_PATH, "..", "..", "README.md")
WINDOWS_README_PATH = os.path.join(BASE_PATH, "..", "..", "win", "README.md")
...
DRIVER_URL_TEMPLATE = {
    ...
    (OSKind.Windows, Product.GeForce, WinSeries.win10, "DCH"): [
    ...
    (
        ...
        WinSeries.win7,
        "",
    ): "https://international.download.nvidia.com/Windows/Quadro_Certified/$version/$version-quadro-rtx-desktop-notebook-win8-win7-64bit-international-whql.exe",
    (
        OSKind.Windows,
        Product.Quadro,
        WinSeries.ws2012,
        "",
    ): "https://international.download.nvidia.com/Windows/Quadro_Certified/$version/$version-quadro-rtx-winserv-2012r2-64bit-international-whql.exe",
    (
        OSKind.Windows,
        Product.Quadro,
        WinSeries.ws2016,
        "",
    ): "https://international.download.nvidia.com/Windows/Quadro_Certified/$version/$version-quadro-rtx-winserv-2016-2019-64bit-international-whql.exe",
}
